...
from .views import IndexView,MovieListView,search,register,signin,MovieDetailView,genrelist_view,groupby_list_view,movie_list_view,like_this_movie,dislike_this_movie
urlpatterns=[
